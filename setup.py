...
setup(
  ...
  packages = ['contactssync','contactssync.__data__','contactssync.subtypes'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/nadime/contact-sync-lib/archive/refs/tags/v0.1.4-alpha.tar.gz',    # I explain this later on
